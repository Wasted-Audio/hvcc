...
GUI elements and objects in PD patchers are ranslated into an intermediate representation (IR) that [generators](/docs/03.generators.md) and other integrations can use to create a custom user interface.

The top level `GraphRoot` is a dictionary that consists of 4 keys:
...
The list of other graphs that are nested in this graphs. A `Graph` can have the following keys:
