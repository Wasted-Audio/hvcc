...
An intermediate result GUI json is created containing these objects with their location, size and style. More information about [the IR](/docs/11.heavy_gui_ir.md).
