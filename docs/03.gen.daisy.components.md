...
Some boards like the [Patch](https://github.com/Wasted-Audio/hvcc/blob/develop/hvcc/generators/c2daisy/json2daisy/resources/patch.json) and [Field](https://github.com/Wasted-Audio/hvcc/blob/develop/hvcc/generators/c2daisy/json2daisy/resources/field.json) have an onboard OLED display.
...
```cpp
  ...
  sprintf(tmp, "counter: %d", (int)fcustom1);
