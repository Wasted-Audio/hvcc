...
from interpreters.pd2hv.HeavyGraph import HeavyGraph  # pre-converted Heavy graphs
...
class PdParser:
    ...
    def get_supported_objects(clazz):
        ...
        pd_objects.extend(list(PdParser.__PD_CLASSES.keys()))
        return pd_objects
    ...
    def graph_from_file(self, file_path, obj_args=None, pos_x=0, pos_y=0, is_root=True, pd_graph_class=PdGraph):
        ...
        canvas_line = next(file_iterator)
